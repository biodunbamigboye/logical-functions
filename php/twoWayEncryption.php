...
function encryptWithDynamicKey($data): string
{
    return twoWayEncryption($data, 'encrypt', 'dynamic');
}

function decryptWithDynamicKey($data): string
{
...
also taking advantage of namespace to avoid collision of function name
